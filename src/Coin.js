// Coin entity class
// Represents a coin placed in the room grid
...
export class Coin {
    ...
    /**
     * Renders the coin to the canvas
    ...
    render(ctx, renderer, cellSize, offsetX = 0, offsetY = 0) {
        const pixelX = offsetX + 4 + this.x * cellSize;
        const pixelY = offsetY + 5 + this.y * cellSize;
        const scale = cellSize / 14; // Assuming 10x10 pixel sprites
